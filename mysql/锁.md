...
2018-09-21 19:46:47 7f99a0a93700
*** (1) TRANSACTION:
TRANSACTION 21062396, ACTIVE 0 sec inserting
mysql tables in use 1, locked 1
LOCK WAIT 4 lock struct(s), heap size 1184, 2 row lock(s)
MySQL thread id 8774783, OS thread handle 0x7f99a04bc700, query id 126950921 100.81.129.60 betamagic update
insert into test4 (id) values (9)
*** (1) WAITING FOR THIS LOCK TO BE GRANTED:
RECORD LOCKS space id 24470 page no 3 n bits 72 index `PRIMARY` of table `f_fuwu_kie`.`test4` trx id 21062396 lock_mode X insert intention waiting
*** (2) TRANSACTION:
TRANSACTION 21062400, ACTIVE 0 sec inserting, thread declared inside InnoDB 1
mysql tables in use 1, locked 1
4 lock struct(s), heap size 1184, 2 row lock(s)
MySQL thread id 8774785, OS thread handle 0x7f99a0a93700, query id 126950922 100.81.129.60 betamagic update
insert into test4 (id) values (9)
*** (2) HOLDS THE LOCK(S):
RECORD LOCKS space id 24470 page no 3 n bits 72 index `PRIMARY` of table `f_fuwu_kie`.`test4` trx id 21062400 lock mode S
*** (2) WAITING FOR THIS LOCK TO BE GRANTED:
RECORD LOCKS space id 24470 page no 3 n bits 72 index `PRIMARY` of table `f_fuwu_kie`.`test4` trx id 21062400 lock_mode X insert intention waiting
